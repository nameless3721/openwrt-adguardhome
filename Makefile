...
PKG_VERSION:=0.105.0-beta.2
PKG_RELEASE:=20201123
...
define Package/$(PKG_NAME)
	...
	DEPENDS:=+kmod-tun +htop +bind-dig +nano +luci-app-openclash +luci-app-wireguard +luci-app-smartdns +luci-app-adguardhome +openssh-sftp-server +luci-app-ttyd +luci-app-vnstat +iptables-mod-tproxy +iptables-mod-extra +libcap +libcap-bin +ruby +ruby-yaml +git +git-http +wget +curl +node +node-npm +perl +moreutils
