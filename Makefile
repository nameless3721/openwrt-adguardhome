...
define Package/$(PKG_NAME)
	...
	DEPENDS:=+kmod-tun +htop +bind-dig +nano +luci-app-openclash +luci-app-wireguard +clash +luci-app-smartdns +luci-app-adguardhome +openssh-sftp-server +luci-app-ttyd
