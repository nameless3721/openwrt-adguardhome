...
define Package/$(PKG_NAME)
	...
	DEPENDS:=+kmod-tun +htop +bind-dig +nano +luci-app-openclash +luci-app-wireguard +luci-app-smartdns +luci-app-adguardhome +openssh-sftp-server +luci-app-ttyd +iptables-mod-tproxy +iptables-mod-extra +libcap +libcap-bin +ruby +ruby-yaml +git +git-http +wget +curl +node +node-npm +perl +moreutils
